...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        def newsListBuilder(a, b, c, d, e):
            ...
            naughtyArticles = ['Pictures from Space!', 'The top space stories of the week!', 'Black Friday', 'Best telescopes']                        # The list of articles to look for
        ...
        # the header
        crewHead = "Current Expedition Crew                                                         Expedition 64"
